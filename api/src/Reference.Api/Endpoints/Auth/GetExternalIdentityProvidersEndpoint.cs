...
/// token. Anonymous only under DEVELOP (matches <see cref="GetCurrentTenantEndpoint"/>); every other
/// configuration requires the policy.
/// </remarks>
[ExcludeFromCodeCoverage]
public sealed class GetExternalIdentityProvidersEndpoint : GetExternalIdentityProvidersEndpointBase
{
