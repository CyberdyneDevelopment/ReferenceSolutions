...
/// <summary>Record model for the <c>auth.OpenIddictApplicationPermission</c> child table. Version-on-write child of <see cref="OpenIddictApplicationRecord"/>.</summary>
[GenerateMapper]
internal sealed partial class OpenIddictApplicationPermissionRecord
{

    /// <summary>Logical Id of the parent application (OpenIddictApplication.Id).</summary>
    public Guid ApplicationId { get; set; }

    /// <summary>OpenIddict permission string (e.g. 'ept:token', 'gt:client_credentials', 'scp:fdw.api').</summary>
