...
/// <summary>
/// Storage container created from discovered schema.
/// </summary>
...
public sealed class DiscoveredStorageContainer : IStorageContainer
{
    ...
    /// <param name="containerType">The discovered container kind (table, view, stored procedure).</param>
    ...
    /// <param name="schemaName">The owning SQL schema name, e.g. <c>dbo</c>.</param>
