...
public class GetDataSetSourcesEndpoint : GetDataSetSourcesEndpointBase
{
    /// <summary>
    ...
    /// <inheritdoc />
    protected override Task<IGenericResult<List<DataSetSourcePayload>?>> LoadDataSetSources(string dataSetName, CancellationToken ct)
    {
