...
namespace ReferenceEtlJobs.Endpoints.Logging;
...
public static partial class EtlServerLog
{
    ...
    // Why 10228 is not reused: ControlDb was purged from the framework, and this logged a
    // connection this server never makes. The number stays retired so a historical log line
    // cannot be confused with something new.
