...
namespace ReferenceExecution.Endpoints.Logging;
...
public static partial class ExecutionLog
{
    ...
    [MessageLogging(EventId = 8400, Level = LogLevel.Trace, Message = "Triggering workflow '{workflowName}' with correlation ID '{correlationId}'")]
    ...
    [MessageLogging(EventId = 8410, Level = LogLevel.Trace, Message = "Fetching execution '{executionId}'")]
    ...
    [MessageLogging(EventId = 8414, Level = LogLevel.Trace, Message = "Listing executions (page {page}, size {pageSize})")]
    ...
    [MessageLogging(EventId = 8416, Level = LogLevel.Trace, Message = "Querying executions by correlation ID '{correlationId}'")]
    ...
    [MessageLogging(EventId = 8420, Level = LogLevel.Trace, Message = "Fetching events for execution '{executionId}'")]
    ...
    [MessageLogging(EventId = 8430, Level = LogLevel.Trace, Message = "Cancelling execution '{executionId}'")]
    ...
    [MessageLogging(EventId = 8433, Level = LogLevel.Trace, Message = "Pausing execution '{executionId}'")]
    ...
    [MessageLogging(EventId = 8436, Level = LogLevel.Trace, Message = "Resuming execution '{executionId}'")]
    ...
    [MessageLogging(EventId = 8440, Level = LogLevel.Trace, Message = "Fetching children for execution '{executionId}'")]
