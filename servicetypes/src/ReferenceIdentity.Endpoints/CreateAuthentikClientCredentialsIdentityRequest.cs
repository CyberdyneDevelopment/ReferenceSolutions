...
/// <summary>
/// Creates an identity that authenticates to Authentik with a client id and secret.
/// </summary>
/// <remarks>
...
public sealed class CreateAuthentikClientCredentialsIdentityRequest : CreateIdentityRequest
{
