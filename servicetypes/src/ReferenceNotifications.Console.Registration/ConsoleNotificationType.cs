...
namespace ReferenceNotifications.Console.Registration;
            ...
            defaultContainerName: "ConsoleNotification")
    {
        ...
        Initialization((host, loggerFactory) =>
        {
            ...
            services.GetRequiredService<NotificationConfigurationProvider>()
                .Register(
                    Name,
                    services.GetRequiredService<ConsoleNotificationConfigurationProvider>());
        ...
        Registration((builder, loggerFactory) =>
        {
            ...
            builder.Services.TryAddSingleton(sp => new ConsoleNotificationConfigurationProvider(
                sp.GetRequiredService<ILoggerFactory>().CreateLogger<ConsoleNotificationConfigurationProvider>(),
            ...
            builder.Services.TryAddSingleton<IServiceConfigurationProvider<ConsoleNotificationConfiguration>>(
                sp => sp.GetRequiredService<ConsoleNotificationConfigurationProvider>());
