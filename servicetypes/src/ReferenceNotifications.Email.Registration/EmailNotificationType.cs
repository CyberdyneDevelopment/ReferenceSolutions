...
namespace ReferenceNotifications.Email.Registration;
    ...
    : NotificationTypeBase<INotificationService, IEmailNotificationFactory, EmailNotificationConfiguration>
{
            ...
            defaultContainerName: "EmailNotification")
    {
        ...
        Initialization((host, loggerFactory) =>
        {
            ...
            var configProvider = services.GetRequiredService<EmailNotificationConfigurationProvider>();
        ...
        Registration((builder, loggerFactory) =>
        {
            ...
            builder.Services.TryAddSingleton(sp => new EmailNotificationConfigurationProvider(
                sp.GetRequiredService<ILoggerFactory>().CreateLogger<EmailNotificationConfigurationProvider>(),
            ...
            builder.Services.TryAddSingleton<IServiceConfigurationProvider<EmailNotificationConfiguration>>(
                sp => sp.GetRequiredService<EmailNotificationConfigurationProvider>());
