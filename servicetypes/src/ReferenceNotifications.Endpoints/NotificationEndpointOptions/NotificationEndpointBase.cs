...
/// <summary>
/// Base for an endpoint over the notification resource.
/// </summary>
/// <remarks>
...
/// </remarks>
public abstract class NotificationEndpointBase : EndpointTypeOptionBase
{
    /// <summary>
    ...
    protected NotificationEndpointBase(string name, Type endpointType, string description)
        : base(name, endpointType, description, "NotificationEndpoint")
    {
    }
}

/// <summary>
/// Base for a notification endpoint that takes its identity from the endpoint class itself.
/// </summary>
/// <typeparam name="TEndpoint">The endpoint class this option declares.</typeparam>
public abstract class NotificationEndpointBase<TEndpoint> : NotificationEndpointBase
    where TEndpoint : class
{
    /// <summary>
    /// Initializes a new instance of the <see cref="NotificationEndpointBase{TEndpoint}"/> class.
    /// </summary>
