...
namespace ReferenceNotifications.Webhook.Registration;
    ...
    : NotificationTypeBase<INotificationService, IWebhookNotificationFactory, WebhookNotificationConfiguration>
{
            ...
            defaultContainerName: "WebhookNotification")
    {
        ...
        Initialization((host, loggerFactory) =>
        {
            ...
            var configProvider = services.GetRequiredService<WebhookNotificationConfigurationProvider>();
        ...
        Registration((builder, loggerFactory) =>
        {
            ...
            builder.Services.TryAddSingleton(sp => new WebhookNotificationConfigurationProvider(
                sp.GetRequiredService<ILoggerFactory>().CreateLogger<WebhookNotificationConfigurationProvider>(),
            ...
            builder.Services.TryAddSingleton<IServiceConfigurationProvider<WebhookNotificationConfiguration>>(
                sp => sp.GetRequiredService<WebhookNotificationConfigurationProvider>());
