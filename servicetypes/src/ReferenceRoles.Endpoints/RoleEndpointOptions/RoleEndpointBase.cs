...
/// <summary>
/// Base for an endpoint over the role resource.
/// </summary>
/// <remarks>
...
/// </remarks>
public abstract class RoleEndpointBase : EndpointTypeOptionBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RoleEndpointBase"/> class.
    /// </summary>
    ...
    protected RoleEndpointBase(string name, Type endpointType, string description)
        : base(name, endpointType, description, "RoleEndpoint")
    {
    }
}

/// <summary>
/// Base for a role endpoint that takes its identity from the endpoint class itself.
/// </summary>
/// <typeparam name="TEndpoint">The endpoint class this option declares.</typeparam>
public abstract class RoleEndpointBase<TEndpoint> : RoleEndpointBase
    where TEndpoint : class
{
    /// <summary>
    /// Initializes a new instance of the <see cref="RoleEndpointBase{TEndpoint}"/> class.
    /// </summary>
    protected RoleEndpointBase()
