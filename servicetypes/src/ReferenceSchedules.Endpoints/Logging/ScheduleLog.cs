...
namespace ReferenceSchedules.Endpoints.Logging;
...
public static partial class ScheduleLog
{
    ...
    [MessageLogging(EventId = 8300, Level = LogLevel.Trace, Message = "Creating schedule '{name}' for pipeline '{pipelineName}'")]
    ...
    [MessageLogging(EventId = 8310, Level = LogLevel.Trace, Message = "Fetching schedule '{name}'")]
    ...
    [MessageLogging(EventId = 8314, Level = LogLevel.Trace, Message = "Listing schedules (page {page}, size {pageSize})")]
    ...
    [MessageLogging(EventId = 8320, Level = LogLevel.Trace, Message = "Updating schedule '{name}'")]
    ...
    [MessageLogging(EventId = 8330, Level = LogLevel.Trace, Message = "Deleting schedule '{name}'")]
