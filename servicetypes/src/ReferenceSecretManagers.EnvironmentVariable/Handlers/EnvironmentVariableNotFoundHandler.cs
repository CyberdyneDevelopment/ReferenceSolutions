...
/// <summary>
/// NotFound sentinel handler for Environment Variable command lookup.
/// </summary>
[TypeOption(typeof(EnvironmentVariableCommandHandlers), "NotFound")]
[ExcludeFromCodeCoverage]
public sealed class EnvironmentVariableNotFoundHandler : ISecretManagerCommandHandler
{
    /// <summary>
    /// Initializes a new instance of the <see cref="EnvironmentVariableNotFoundHandler"/> class.
    /// </summary>
    public EnvironmentVariableNotFoundHandler()
    {
