...
/// <summary>
/// NotFound sentinel handler for MsSql command lookup.
/// </summary>
[TypeOption(typeof(MsSqlCommandHandlers), "NotFound")]
[ExcludeFromCodeCoverage]
public sealed class MsSqlNotFoundHandler : ISecretManagerCommandHandler
{
    /// <summary>
    /// Initializes a new instance of the <see cref="MsSqlNotFoundHandler"/> class.
    /// </summary>
    public MsSqlNotFoundHandler()
    {
